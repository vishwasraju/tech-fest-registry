...
const Header = () => {
  return <header className="glass sticky top-0 z-50 w-full">
      <div className="container mx-auto flex h-21 items-center justify-between px-8">
        <Link to="/" className="flex items-center">
          <img alt="Tech Fest 2K25 Logo" className="h-21" src="/lovable-uploads/b48f0e78-d806-4c37-b311-4cd931398c4f.png" />
        </Link>
